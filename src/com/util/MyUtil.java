...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		if(currentPageSetup > 0 && total_page > numPerBlock) {
			sb.append("<li>");
			sb.append("<a href='"+list_url+"page=1'><i class=\"fa fa-angle-double-left\"></a>");
			sb.append("</li>");
			sb.append("<li>");
			sb.append("<a href='"+list_url+"page="+n+"'><i class=\"fa fa-angle-left\"></i></a>");
			sb.append("</li>");
		}
		...
		if(total_page - currentPageSetup > numPerBlock) {
			sb.append("<li>");
			sb.append("<a href='"+list_url+"page="+n+"'><i class=\"fa fa-angle-right\"></i></a>");
			sb.append("</li>");
			sb.append("<li>");
			sb.append("<a href='"+list_url+"page="+total_page+"'><i class=\"fa fa-angle-double-right\"></i></a>");
			sb.append("</li>");
		}
    ...
    public String pagingMethod(int current_page, int total_page, String methodName) {
        ...
        if ((total_page > numPerBlock) && (currentPageSetUp > 0)) {			
			sb.append("<li>");
			sb.append("<a onclick='"+methodName+"(1)'><i class=\"fa fa-angle-double-left\"></a>");
			sb.append("</li>");
			sb.append("<li>");
			sb.append("<a onclick='"+methodName+"("+n+")'><i class=\"fa fa-angle-left\"></i></a>");
			sb.append("</li>");
        }
        ...
        if (total_page - currentPageSetUp > numPerBlock) {
			sb.append("<li>");
			sb.append("<a onclick='"+methodName+"("+n+");'><i class=\"fa fa-angle-right\"></i></a>");
			sb.append("</li>");
			sb.append("<li>");
			sb.append("<a onclick='"+methodName+"("+total_page+");'><i class=\"fa fa-angle-double-right\"></i></a>");
			sb.append("</li>");
        }
		sb.append("</ul>");

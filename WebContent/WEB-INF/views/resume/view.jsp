					...
					<div>
						...
						<form name="resumeForm" method="post">
							<input type="text" id="title" name="title"
								style="width: 50%; margin: 10px 5px 10px;"
								value="${dto_resume.title}" disabled="disabled"> <br>
							<h3 style="background-color:#4c4c4c;color:#ffffff;padding:10px;">| 개인 정보</h3>
							<div id="personalInfo">
								&nbsp; <input type="text" name="name" style="width: 30%;"
									autofocus value="${dto_resume.name}" disabled="disabled">
								&nbsp; <input type="text" name="birth" style="width: 30%;"
									maxlength="10" value="${dto_resume.birth}" disabled="disabled">
								&nbsp; <label for="gender">성별</label> <input type="text"
									name="gender" size="10" value="${dto_resume.gender}"
									disabled="disabled">
							</div>
							<div>
								<br> &nbsp; <input type="text" name="userEmail" size="30"
									value="${sessionScope.member.email}" disabled="disabled">
								<br>
								<br> &nbsp; <input type="text" id="addr" name="addr"
									style="width: 80%;" value="${dto_resume.addr}"
									disabled="disabled"> <br>
								<br>
								<button class="btn btn-black basicChange" type="button"
									style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">변경</button>
								<button class="btn btn-black updateBasic" type="button"
									style="float: right; margin-right: 10px; height: 26px; line-height: 10px; display: none">저장</button>
								<br>
								<br>
								<hr>
							</div>
							...
							<div class="inputBox">
								<div id="educationInfo">
									&nbsp; <label for="educationCode">&nbsp; 최종학력</label> <br>
									...
									</select> &nbsp; <input type="text" size="10" id="schoolName"
										name="schoolName" placeholder="학교명"
										value="${dto_edu.schoolName}" disabled="disabled">
									&nbsp; <label for="region">지역</label> <select size="1"
										name="region" id="region" disabled="disabled">
									...
									</select> &nbsp; <input type="text" size="10" id="major" name="major"
										placeholder="전공/학과명" value="${dto_edu.major}"
										disabled="disabled"> <br>
									<br> &emsp; <label><input type="checkbox"
										id="graduate_status" name="graduate_status" placeholder="재학중"
										value=${dto_edu.graduate_status!=null?"checked='checked'":""}
										disabled="disabled">재학중</label> &emsp; <input type="text"
										title="calendar" id="entrance" name="entrance"
										placeholder="입학일자" value="${dto_edu.entrance}"
										style="width: 100px;" disabled="disabled"> <input
										type="text" title="calendar" id="graduate" name="graduate"
										placeholder="졸업일자" value="${dto_edu.graduate}"
										style="width: 100px;" disabled="disabled">
									<button class="btn btn-black educationChange" type="button"
										style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">변경</button>
									<button class="btn btn-black updateEducation" type="button"
										style="float: right; margin-right: 10px; height: 26px; line-height: 10px; display: none">저장</button>
									<br>
									<br>
								</div>
								...
								<div class="inputBox">
									<div id="licenseInfo">
										<div style="display: none;">
											<input type="hidden" name="licenseCode"> &nbsp; <input
												type="text" size="10" name="licenseName" placeholder="자격증명">
											&nbsp; <input type="text" size="10" name="licensePublisher"
												placeholder="발급처"> &nbsp; <input type="text"
												name="licenseDate" placeholder="취득 날짜" style="width: 100px;">
											<button class="btn btn-black removeLicense" type="button"
												style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
											<button class="btn btn-black addLicense" type="button"
												style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">추가완료</button>
											<br>
											<br>
										</div>
										<c:forEach var="dto" items="${licenseList}">
											<div>
												<input type="hidden" name="licenseCode"
													value="${dto.licenseCode}"> &nbsp; <input
													type="text" size="10" name="licenseName" placeholder="자격증명"
													value="${dto.license_name}" disabled="disabled">
												&nbsp; <input type="text" size="10" name="licensePublisher"
													placeholder="발급처" value="${dto.license_publisher}"
													disabled="disabled"> &nbsp; <span
													class="datepicker_wrap"> <input type="text"
													title="calendar" name="licenseDate" placeholder="취득 날짜"
													value="${dto.license_date}" style="width: 100px;"
													disabled="disabled">
												</span>
												<button class="btn btn-black removeLicense" type="button"
													style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
								...
								<div class="inputBox">
									<div id="awardsInfo">
										<div style="display: none;">
											<input type="hidden" name="awardsCode"> &nbsp; <input
												type="text" size="10" name="awardsName" placeholder="수상명">
											&nbsp; <input type="text" size="10" name="awardsPublisher"
												placeholder="발급처"> &nbsp; <input type="text"
												name="awardsDate" placeholder="수상 날짜" style="width: 100px;">
											<button class="btn btn-black removeAwards"
												style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
											<button class="btn btn-black addAwards" type="button"
												style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">추가완료</button>
											<br>
											<br>
										</div>
										<c:forEach var="dto" items="${awardList}">
											<div>
												<input type="hidden" name="awardsCode"
													value="${dto.awardsCode}"> &nbsp; <input
													type="text" size="10" name="awardsName" placeholder="수상명"
													value="${dto.awardsName}" disabled="disabled">
												&nbsp; <input type="text" size="10" name="awardsPublisher"
													placeholder="발급처" value="${dto.awards_publisher}"
													disabled="disabled"> &nbsp; <input type="text"
													name="awardsDate" placeholder="수상 날짜"
													value="${dto.awards_date}" style="width: 100px;"
													disabled="disabled">
												<button class="btn btn-black removeAwards"
													style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
												<br>
							...
							<div class="inputBox">
								<div id="careerInfo">
									<div style="display: none;">
										<input type="hidden" name="careerCode"> &nbsp; <input
											type="text" size="10" name="copName" placeholder="회사명">
										&nbsp; <label for="gubun">경력구분</label> <select size="1"
											name="gubun">
											<option value="intern">인턴</option>
											<option value="contract">계약직</option>
											<option value="regular">정규직</option>
											<option value="dispatch">파견직</option>
										</select> &nbsp; <input type="text" size="10" name="position"
											placeholder="직위"> <br> &nbsp; <input type="text"
											size="10" name="task" placeholder="업무내용"> <input
											type="text" title="calendar" name="carrerjoinDate"
											placeholder="입사일자" style="width: 100px;"> <input
											type="text" title="calendar" name="carrerresignDate"
											placeholder="퇴사일자" style="width: 100px;">
										<button class="btn btn-black removeCareer"
											style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
										<button class="btn btn-black addCareer" type="button"
											style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">추가완료</button>
										<br> <br>
									</div>
									<c:forEach var="dto" items="${CareerList}">
										<div>
											<input type="hidden" name="careerCode"
												value="${dto.careerCode}"> &nbsp; <input type="text"
												size="10" name="copName" placeholder="회사명"
												value="${dto.copName}" disabled="disabled"> &nbsp; <label
												for="gubun">경력구분</label> <select size="1" name="gubun"
												disabled="disabled">
												<option value="intern">인턴</option>
												<option value="contract">계약직</option>
												<option value="regular">정규직</option>
												...
												placeholder="직위" value="${dto.position}" disabled="disabled">
											<br> &nbsp; <input type="text" size="10" name="task"
												placeholder="업무내용" value="${dto.task}" disabled="disabled">
											<input type="text" title="calendar" name="carrerjoinDate"
												placeholder="입사일자" value="${dto.joinDate}"
												style="width: 100px;" disabled="disabled"> <input
												type="text" title="calendar" name="carrerresignDate"
												placeholder="퇴사일자" value="${dto.resignDate}"
												style="width: 100px;" disabled="disabled">
											<button class="btn btn-black removeCareer"
												style="float: right; margin-right: 10px; height: 26px; line-height: 10px;">삭제</button>
											<br> <br>
								...
								<p align="center">
									<button type="button" class="btn btn-black" id="addCareer"
										style="height: 26px; line-height: 5px;">추가</button>
								</p>
							</div>
							<div class="t_center p20" style="border-top:1px solid #c4c4c4;">
								<a href="<%=cp%>/resume/update_ok.do"
									class="btn_classic btn-black mt20">수정완료</a><a
									href="<%=cp%>/resume/list.do"
									class="btn_classic btn-black mt20 ml5">취소</a> <br>
							</div>
						</form>
					</div>
				</div>
